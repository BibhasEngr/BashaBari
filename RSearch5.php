...
<div class="w">
	<?php
	$search1= mysqli_real_escape_string($conn, $_POST['search1']);
 	 $search3= mysqli_real_escape_string($conn, $_POST['search3']);
 	  $search4= mysqli_real_escape_string($conn, $_POST['search4']);
	$sql= "SELECT * FROM addhouse WHERE city= '$search1' AND rent BETWEEN '$search3' AND '$search4'  ";
	$result= mysqli_query($conn, $sql);
	$queryResult= mysqli_num_rows($result);
	echo"Total '$queryResult' results found for your search "
